...
export const Airpollution = (props) => {
  ...
  return (
    ...
    <div className="flex h-screen absolute w-screen justify-start items-end overflow-hidden ">
      ...
      <div className="w-[200px] h-[70px] bg-white rounded-lg flex justify-evenly items-center">
        <div className="w-[50px] h-[50px] rounded-lg flex justify-center items-center text-4xl font-semibold ">{Airpollutionemoji()}</div>
        ...
        <div className="w-[50px] h-[50px] rounded-lg flex justify-center items-center text-4xl font-semibold "> <UseAnimations animation={activity} size={56} /></div>
