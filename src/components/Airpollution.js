...
export const Airpollution = (props) => {
  ...
  const Airpollutionbg = () => {
    if (weather.airquality <= 50) {
      return (<div className="w-[200px] h-[10px] bg-green "></div>);
    } else if (weather.airquality <= 100) {
      return (<div className="w-[200px] h-[10px] bg-yellow"></div>);
    } else if (weather.airquality <= 150) {
      return (<div className="w-[200px] h-[10px] bg-orange "></div>);
    } else if (weather.airquality <= 200) {
      return (<div className="w-[200px] h-[10px] bg-red "></div>);
    } else if (weather.airquality <= 300) {
      return (<div className="w-[200px] h-[10px] bg-purple "></div>);
    } else if (weather.airquality <= 500) {
      return (<div className="w-[200px] h-[10px] bg-maroon "></div>);
    }
  };
  ...
  return (
    <div className="flex h-screen absolute w-screen justify-start items-end overflow-hidden ">
      {weatherLoding ? (
        ...
        <div className="w-[200px] h-[70px] bg-white rounded-lg flex justify-evenly items-center flex-col">
          ...
          <div className="w-[200px] h-[10px] ">{Airpollutionbg()}</div>
        </div>
      )}
    </div>
  );
